...
## Latest Development — Stage 2: Mathematical Concept Agent

Stage 2 explores AI-assisted mathematical concept formation through structural research, conjecture, exact derivation, counterexample search, and independent verification. It provides a lightweight, resumable research controller built on Codex and remains under active development. See the [Stage 2 documentation](mathematical-concept-agent/README.md) for its source structure, requirements, and usage.

---

## Stage 1: Mathematical Object Origin Archive Runner
